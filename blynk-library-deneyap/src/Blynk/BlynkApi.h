...
public:
     ...
     */
    template <typename T_Blynk, typename... Args>
    void setProperty(int pin, const T_Blynk& property, Args... values) {
        char mem[BLYNK_MAX_SENDBYTES];
        BlynkParam cmd(mem, 0, sizeof(mem));
        cmd.add(pin);
        cmd.add(property);
    ...
    void setProperty(int pin, const T_Blynk& property, const BlynkParam& param) {
        char mem[32];
        BlynkParam cmd(mem, 0, sizeof(mem));
        cmd.add(pin);
        cmd.add(property);
    ...
    template <typename T_Blynk>
    void setProperty(int pin, const T_Blynk& property, const BlynkParamAllocated& param) {
        char mem[32];
        BlynkParam cmd(mem, 0, sizeof(mem));
        cmd.add(pin);
        cmd.add(property);
